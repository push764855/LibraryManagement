...
public class FindOrderController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (list != null) {
                String userID =(String) session.getAttribute("USER_ID_SEARCH");
                String bookID = request.getParameter("txtFindOrderByBookID");
                OrderDetailDAO dao = new OrderDetailDAO();
                List<OderDetailDTO> newList = dao.FindByBookID(userID, bookID);
                session.setAttribute("LIST_ORDERED", newList);
            }
        } catch (Exception e) {
        }finally{
